...
| 🚀 WinUI 3 .NET 10 Walk-Through | [gigasoft.com/winui-chart](https://gigasoft.com/winui-chart) |
| 🚀 WPF Walk-Through | [gigasoft.com/wpf-chart-nuget](https://gigasoft.com/wpf-chart-nuget) |
| 🚀 WinForms Walk-Through | [gigasoft.com/net-chart-nuget](https://gigasoft.com/net-chart-nuget) |
...
| 📦 NuGet packages | [nuget.org/profiles/GigasoftInc](https://www.nuget.org/profiles/GigasoftInc) |
...
| Preview | Demo |
| --- | --- |
| <a href="https://github.com/GigasoftInc/winui-chart-quickstart-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/winui-chart-quickstart-proessentials/main/docs/winui-chart-quickstart-net10.png" width="300" alt="winui-chart-quickstart-proessentials"></a> | **Quickstart — Clone, Build, Run**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-quickstart-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-quickstart-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-quickstart-proessentials)<br><br>The simplest starting point: a single `Pesgo` scientific chart (Example 100, *Simple Scientific Graph*) plotting four subsets of random performance data with gradient + bevel plotting, dot grid, zoom/pan, and a tracking tooltip. Direct2D. |
| <a href="https://github.com/GigasoftInc/winui-chart-multi-axis-layout-explorer-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/winui-chart-multi-axis-layout-explorer-proessentials/main/docs/winui-chart-multi-axis-layout-explorer.png" width="300" alt="winui-chart-multi-axis-layout-explorer-proessentials"></a> | **Multi-Axis Layout Explorer**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-multi-axis-layout-explorer-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-multi-axis-layout-explorer-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-multi-axes-tutorial-proessentials)<br><br>A single `Pesgo` scientific chart displaying engine dyno data (HP, Torque, Temperature, Pressure vs RPM) across four instantly switchable axis layout modes, with a toggle that moves Pressure to the right Y axis in whichever layout is active. Mixed plotting methods per subset (Bar, SplineArea, PointsPlusLine, Spline). Direct2D. |
| <a href="https://github.com/GigasoftInc/winui-chart-mouse-interaction-hotspots-coordinate-tracking-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/winui-chart-mouse-interaction-hotspots-coordinate-tracking-proessentials/main/docs/winui-chart-mouse-interaction-hotspots.png" width="300" alt="winui-chart-mouse-interaction-hotspots-coordinate-tracking-proessentials"></a> | **Mouse Interaction & Hot Spots**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-mouse-interaction-hotspots-coordinate-tracking-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-mouse-interaction-hotspots-coordinate-tracking-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-mouse-interaction-hotspots-proessentials)<br><br>A dual-Y-axis `Pego` chart that combines two complementary mouse-interaction techniques: a `ConvPixelToGraph` tooltip showing both Y-axis values at the cursor, and a `GetHotSpot` status bar that names the chart element under the cursor (data point, series legend, or point label). Direct2D. |
| <a href="https://github.com/GigasoftInc/wpf-chart-custom-yaxis-labels-annotations-events-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/wpf-chart-custom-yaxis-labels-annotations-events-proessentials/main/docs/WpfChartCustomScales.png" width="300" alt="wpf-chart-custom-yaxis-labels-annotations-events-proessentials"></a> | **Custom Y-Axis Labels & Annotations**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-custom-yaxis-labels-annotations-events-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-custom-yaxis-labels-annotations-events-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-custom-axis-labels-proessentials)<br><br>.NET 8 — two approaches to custom Y-axis labels shown side-by-side in one chart split into stacked multi-axis sections. Direct2D. |
| <a href="https://github.com/GigasoftInc/winui-chart-log-log-axes-drag-measure-quick-annotations-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/winui-chart-log-log-axes-drag-measure-quick-annotations-proessentials/main/docs/winui-chart-log-log-axes-drag-measure.png" width="300" alt="winui-chart-log-log-axes-drag-measure-quick-annotations-proessentials"></a> | **Log-Log Axes + Drag-Measure Annotations**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-log-log-axes-drag-measure-quick-annotations-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-log-log-axes-drag-measure-quick-annotations-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-log-log-axes-quick-annotations-proessentials)<br><br>Log-log scientific scatter chart with intelligent decade-based axis restructuring on zoom, plus a left-drag quick annotation measurement tool that overlays a live measurement rectangle with X/Y delta labels. Direct2D. |
| <a href="https://github.com/GigasoftInc/wpf-chart-bitmap-symbols-jagged-data-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/wpf-chart-bitmap-symbols-jagged-data-proessentials/main/docs/WpfChartBitmapSymbolsJaggedData.png" width="300" alt="wpf-chart-bitmap-symbols-jagged-data-proessentials"></a> | **Bitmap Symbols + Jagged Data**<br>[WinUI](https://github.com/GigasoftInc/winui-chart-bitmap-symbols-jagged-data-proessentials) · [WPF](https://github.com/GigasoftInc/wpf-chart-bitmap-symbols-jagged-data-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-bitmap-symbols-jagged-data-proessentials)<br><br>.NET 8 — a `Pesgo` scatter chart combining custom PNG bitmap symbols with jagged data (a different point count per subset). Direct2D. |

---

## Why ProEssentials vs the Competition?

➡️ [Charting Library Comparison](https://gigasoft.com/why-proessentials)
➡️ [WinUI Chart Performance Comparison](https://gigasoft.com/why-proessentials/winui-chart-performance)
...
➡️ [Plot 100 Million Points — WinUI Comparison](https://gigasoft.com/blog/plot-100-million-points-winui-comparison)
➡️ [Plot 100 Million Points — 5-Library WPF Comparison](https://gigasoft.com/blog/plot-100-million-points-wpf-comparison)
...
We're just starting to build our GitHub and X presence, and we'd genuinely welcome your company. If performant, native charting is your world, come follow along — we share demos, performance experiments, and the occasional 100-million-point render.

[![Follow @GigasoftUSA on X](https://img.shields.io/badge/Follow%20%40GigasoftUSA%20on%20X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/intent/follow?screen_name=GigasoftUSA)

Thank you — a follow, a ⭐ star, or a repost helps another engineer find work like this.
