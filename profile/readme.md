...
| Preview | Demo |
| --- | --- |
| <a href="https://github.com/GigasoftInc/wpf-chart-3d-surface-proessentials"><img src="https://raw.githubusercontent.com/GigasoftInc/wpf-chart-3d-surface-proessentials/main/docs/GigaPrime3D-WpfSurfaceChart.jpg" width="300" alt="wpf-chart-3d-surface-proessentials"></a> | **3D Surface Height Map (flagship 3D/2D demo)**<br>[WPF](https://github.com/GigasoftInc/wpf-chart-3d-surface-proessentials) · [WinForms](https://github.com/GigasoftInc/winforms-chart-3d-surface-proessentials)<br><br>Likely the most impressive functioning, performing, efficient 3D/2D combo example you will find on GitHub. A .NET 8 demonstration of GPU compute shader 3D surface rendering — real material surface and terrain height-map data visualized across three synchronized charts. |
